...
const AGENTS = [
  {
    ...
    icon: Network,
    badge: "8-Agent Mesh",
    desc: "Coordinates all 8 specialized pharmacy & healthcare AI agents in a DAG execution mesh",
  ...
  },
  {
    ...
    name: "8. Telehealth Doctor Match",
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/25 backdrop-blur-md text-xs font-black uppercase tracking-widest text-emerald-300 mb-4">
            ...
            MediFinder India — 8 Specialized Healthcare Agentic AI Suite
          </div>
          ...
          <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-semibold max-w-2xl">
            Deploy 8 specialized healthcare & pharmacy AI agents working independently or collaboratively via our Multi-Agent Swarm Orchestrator.
          </p>
          ...
          <div className="mt-5 flex flex-wrap items-center gap-3 text-xs font-black text-slate-200">
            <span className="flex items-center gap-1.5 bg-white/10 px-3 py-1.5 rounded-xl border border-white/15">
              <Activity className="w-4 h-4 text-emerald-400" /> 8 Active Specialized Agents
            </span>
            <span className="flex items-center gap-1.5 bg-white/10 px-3 py-1.5 rounded-xl border border-white/15">
              <Network className="w-4 h-4 text-sky-400" /> 8-Agent Swarm DAG Engine
            </span>
            <span className="flex items-center gap-1.5 bg-white/10 px-3 py-1.5 rounded-xl border border-white/15">
